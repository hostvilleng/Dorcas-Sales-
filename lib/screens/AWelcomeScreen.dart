...
import 'package:dorcashub/screens/ALoginScreen.dart';
import 'package:dorcashub/screens/ARegisterScreen.dart';
      ...
      appBar: AppBar(
        ...
        leading: Container(
          ...
          child: InkWell(
            ...
            child: Icon(Icons.arrow_back_ios_outlined, color: Colors.blueAccent, size: 20),
          ),
        ),
        title: Align(
          alignment: Alignment.center,
          child: Text('Docashub', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: context.iconColor)),
        ),
        actions: [
          Container(
            decoration: BoxDecoration(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(25),
              child: Icon(Icons.help_outline_outlined, color: Colors.blueAccent, size: 20),
            ),
          ),
        ],
      ),
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(primary: Color(0xff375BE9), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15))),
                child: Row(
           ...
           // ),
            ...
            Padding(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text('Enter your Partner ID ? ', style: TextStyle(fontWeight: FontWeight.w300)),
                  InkWell(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => ParentAuth())),
                    child: Text('Click Next', style: TextStyle(fontWeight: FontWeight.w700)),
                  ),
                ],
              ),
            ),
