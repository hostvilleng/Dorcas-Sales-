...
final List<AWalkThroughModel> modal = [
  AWalkThroughModel(
    heading: '',
    title: 'Get Across in Seconds',
    subtitle: 'Learn more about dorcashub with amazing rewards  ',
    image: 'image/appetit/p1.jpg',
    progress: 0.33,
  ),
  AWalkThroughModel(
    heading: '',
    title: 'Bring Business Online',
    subtitle: 'Know More about bring your product online',
  ...
  AWalkThroughModel(
    ...
    subtitle: 'Take ownership of your business and manage your Sales, Products and Customers with ease on Dorcas Hub ',
